...
console.log('Key secret', config.razorpayKeySecret);
...
router.post('/verify_payment', authenticateToken, async (req, res) => {
    try {
        ...
        const calculatePrice = (product) => {
            ...
            const item_total_discount = discount_per_unit * qty;
            const item_total_gst = gst_per_unit * qty;
            ...
            return {
                ...
                discount_amount: item_total_discount,
                final_price: item_final_price,
                qty
            };
        };

        // Precalculate all for orderProducts table
        const productDetailsList = orderDetails.cartProducts.map(product => ({
            ...product,
        ...
        const orderValues = [
            ...
            total_amount.toFixed(2), total_gst.toFixed(2), total_discount.toFixed(2), final_total.toFixed(2)
        ];
